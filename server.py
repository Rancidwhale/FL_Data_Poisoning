...
def run_exp(replacement_method, num_poisoned_workers, KWARGS, client_selection_strategy, idx):
    ...
    target_label = 9  # Define the target label for poisoned samples
    ...
    #distributed_train_dataset= poison_data_with_GAN(logger, distributed_train_dataset,args.get_num_workers(), poisoned_workers, target_label)
